...
let imagens = ["caocoragem.jpg", "baby.jpg", "hellokitty.jpg", "monster-high.jpg", "piupiuj.pg.jpg", "snoopy.jpg", "dora.jpg", "bobsponja.jpg"];
...
const tempoLimite = 1 * 60 * 1000; // 1 minuto = 60 segundos = 60 * 1000 milissegundos
var tempoAtual = tempoLimite

function tempoAcabou() {
    alert('O tempo acabou! O jogo será encerrado.');
...
function atualizaTempo(){
    ...
    let tempoEmSegundos = tempoAtual/1000
    document.getElementById("tempo").innerHTML=tempoEmSegundos+" segundos"
    if(tempoAtual<=0){
        tempoAcabou()
    }
}
